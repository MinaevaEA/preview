...
import presentation.flow.detail.extentions.getTitle
import presentation.flow.detail.ui.component.BigImageCategory
...
internal fun DetailCategoryView(
    ...
    Column(
        ...
        BigImageCategory(onBackClick = { intentConsumer(Intent.onBack) }, image = state.category.photo, categoryHuman = state.category)
