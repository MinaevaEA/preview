...
import presentation.common.component.LectureCategory
        ...
        Box(modifier = Modifier.height((233.dp))) {
            ...
            Column(
                ...
                Row(
                    ...
                    Column {
                        Text(
                            lectureHuman.rememberDate(),
                            style = AppTypography.bodyMedium.regular,
                            color = AppColors.neutral10,
                            textAlign = TextAlign.Start
                        )
                        Text(
                            lectureHuman.rememberTime(),
                            style = AppTypography.bodyMedium.regular,
                            color = AppColors.neutral10,
                            textAlign = TextAlign.Start
                        )
...
private fun BigImagePreview() {
    AppTheme {
        Column(
            ...
            BigImage("", CategoryHuman.getPreview(), lectureHuman = LectureHuman.getPreview(), {}, {}, false)
        }
    }
}
